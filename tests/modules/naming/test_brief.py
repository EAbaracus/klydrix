import pytest
from launch_engine.modules.naming.brief import NameTypology, PhoneticConstraints, NamingBrief


def test_name_typology_enum():
    """Test that NameTypology enum has all 8 values."""
    expected = {
        "INVENTED", "DESCRIPTIVE", "SUGGESTIVE", "METAPHORICAL",
        "ACRONYM", "PORTMANTEAU", "FOUNDER", "COMPOUND"
    }
...
def test_naming_brief_all_fields():
    ...
    assert brief.preferred_typologies == [NameTypology.INVENTED, NameTypology.METAPHORICAL]
